      ...
      <div id='body'>
        <div class='test_layout_post' id='test_layout_post_314159'>
          <div class='post-header'>
            <h2 class='post-title'>
              <a class='permalink' href='http://example.com/2009/01/13/test-post.html'>Test Post</a>
            </h2>
            <ul class='post-metadata'>
              ...
              <li class='link'>
                <a class='permalink' href='http://example.com/2009/01/13/test-post.html'>
                  Permalink
                </a>
              </li>
              <li class='comments'>
                <a class='comments' href='http://example.com/2009/01/13/test-post.html##comments'>Comments (0)</a>
              </li>
            </ul>
          </div>
